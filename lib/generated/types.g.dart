...
Product_id_name_2 _$Product_id_name_2FromJson(Map<String, dynamic> json) =>
    Product_id_name_2(
      id: json['id'] as String,
      name: json['name'] as String,
    );

Map<String, dynamic> _$Product_id_name_2ToJson(Product_id_name_2 instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
    };
...
CreateProductResponse _$CreateProductResponseFromJson(
    ...
    CreateProductResponse(
      createProduct: Product_id_name_1.fromJson(
...
DeleteProductResponse _$DeleteProductResponseFromJson(
    ...
    DeleteProductResponse(
      deleteProduct: Product_id_name_2.fromJson(
