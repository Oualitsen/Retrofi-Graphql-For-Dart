...
class AgencyInput {
  ...
  factory AgencyInput.fromJson(Map<String, dynamic> json) =>
      _$AgencyInputFromJson(json);
...
class CashierInput {
  ...
  factory CashierInput.fromJson(Map<String, dynamic> json) =>
      _$CashierInputFromJson(json);
...
class HemodialysisGroupInput {
  ...
  factory HemodialysisGroupInput.fromJson(Map<String, dynamic> json) =>
      _$HemodialysisGroupInputFromJson(json);
...
class AssignmentInput {
  ...
  AssignmentInput(
      ...
      required this.hemodialysisGroup,
      required this.position,
      required this.patientRoom,
      required this.DateOfFirstIronTreatment,
      required this.DateOfFirstEPOTreatment,
      required this.DateOfTheFirstHemodialysisSession});

  factory AssignmentInput.fromJson(Map<String, dynamic> json) =>
      _$AssignmentInputFromJson(json);
...
class PatientRoomInput {
  ...
  PatientRoomInput(
      {required this.code, required this.name, required this.designation});

  factory PatientRoomInput.fromJson(Map<String, dynamic> json) =>
      _$PatientRoomInputFromJson(json);
...
class PositionInput {
  ...
  factory PositionInput.fromJson(Map<String, dynamic> json) =>
      _$PositionInputFromJson(json);
...
class EnsurerInput {
  ...
  EnsurerInput(
      ...
      required this.ensurerRelationship});

  factory EnsurerInput.fromJson(Map<String, dynamic> json) =>
      _$EnsurerInputFromJson(json);
...
class MedicalStaffInput {
  ...
  factory MedicalStaffInput.fromJson(Map<String, dynamic> json) =>
      _$MedicalStaffInputFromJson(json);
